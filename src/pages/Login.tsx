    ...
    <div className='flex items-center justify-center min-h-screen bg-[#eaecf0]'>
      <Card className='w-full max-w-sm w-[500px] h-[450x] '>
        <CardHeader className='flex flex-row items-start justify-between'>
          {/** 왼쪽 영역 : 제목과 설명 */}
          <div className='mt-3'>
            <CardTitle className='text-xl font-bold'>로그인</CardTitle><br/>
            <CardDescription className='text-sm text-muted-foreground'>
              GoFlow에 오신 걸 환영합니다<br />
            </CardDescription>
          </div>
          {/** 오른쪽 영역 : 회원가입 */}
          <div>
            <Button asChild className='bg-[#ffffff] hover:bg-[#eeeded] text-sm font-bold bg-[#ffffff] text-black border' >

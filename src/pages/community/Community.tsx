    ...
    <div className='mt-10'>
      ...
      {isModalOpen && (
        ...
        >
          ...
          <form onSubmit={handleModalSubmit(handleCreateCommunity)} className="space-y-4">
            
            {/* 제목 */}
            <div>
              <label className="block text-sm font-semibold mb-1">커뮤니티명</label>
              <input
            ...
            <div className="flex justify-end gap-2 pt-4">
              <CustomButton variant="primary" type='submit'>생성</CustomButton>
              <CustomButton variant="secondary" onClick={handleCloseModal}>닫기</CustomButton>
            </div>
